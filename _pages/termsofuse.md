...
Please read these Terms of Use, including those set forth in the Privacy Policy ("Terms", "Terms of Use") carefully before using the Invoice Co application (the "App") made available by Karma Academy pty ltd ("us", "we", or "our").
